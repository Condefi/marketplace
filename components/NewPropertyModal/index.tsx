...
const NewCampaignModal = () => {
  const initialFormState = {} as Partial<Property>;
        ...
        return (
          <div className="space-y-4">
            ...
            <Input
              ...
              value={
                formData.attributes
                  ?.find((attr) => attr.trait_type === "Investors")
                  ?.value?.toString()
                  .replace(/[^\d]/g, "") || ""
              }
              onChange={handleInputChange}
        ...
        return (
          <div className="space-y-4">
            ...
            <Select
              ...
              value={
                formData.attributes
                  ?.find((attr) => attr.trait_type === "Property Type")
                  ?.value?.toString() || ""
              }
              onValueChange={(value) =>
                handleInputChange({
            ...
            <Select
              ...
              value={
                formData.attributes
                  ?.find((attr) => attr.trait_type === "Term")
                  ?.value?.toString() || ""
              }
              onValueChange={(value) =>
                ...
                >
                  ...
                  {formData.attributes?.find(
                    ...
                    format(
                      new Date(
                        formData.attributes
                          ?.find((attr) => attr.trait_type === "End Date")
                          ?.value?.toString() || ""
                      ),
                      "PPP"
                    )
            ...
            <ImageInputPreview
              file={
                formData.attributes?.find((attr) => attr.trait_type === "Image")
                  ?.value
                  ? new File([], "")
                  : null
              }
